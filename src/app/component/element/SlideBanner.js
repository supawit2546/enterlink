...
const SlideBanner = () => {
  ...
  return (
    <div className="w-full h-full py-7 px-7 relative">
      <Swiper
        spaceBetween={10}  // ระยะห่างระหว่างสไลด์
        slidesPerView="auto"  // ให้แสดงสไลด์เป็นอัตโนมัติ โดยแสดงบางส่วนของสไลด์ถัดไป
        centeredSlides={true}  // ทำให้สไลด์ตรงกลางอยู่ที่กลาง
