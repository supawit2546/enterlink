...
const SingleBio = ({ userId }) => {
  ...
  console.log("Image URL:", getImageUrl(profile.image_profile));
      ...
      {profile ? (
        <>
          ...
          <div className="w-full flex flex-col justify-center py-3 px-8">
            <h1 className="name-bio text-center">{profile.name}</h1>
            <p className="sub-name-bio text-center">{profile.bio}</p>
          </div>
        </>
      ) : (
